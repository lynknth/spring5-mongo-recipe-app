package linh.springframework.recipeapp.bootstrap;

import linh.springframework.recipeapp.domain.*;
import linh.springframework.recipeapp.repositories.CategoryRepository;
